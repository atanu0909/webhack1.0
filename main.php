...
<?php include 'header.php'?>
		...
		<div id="home" class="hero-area">
			...
			<!-- Backgound Image -->
			<div class="bg-image bg-parallax overlay" style="background-image:url(./img/hh.jpg); width:100%; height: 656px;"></div>
			<!-- /Backgound Image -->
				...
				<div class="container">
					<div class="row">
						<div class="col-md-8">
							...
							margin-bottom:50px;">APC Career Guidance System</h1>
							
							<?php
								// Check if the user is logged in, if not then redirect him to login page
								if(!isset($_SESSION["loggedin"]) || $_SESSION["loggedin"] !== true):?>
									<p class="lead white-text" style="margin-left: 5px;" ><b>Discover yourself<br>Deep Drive to find the perfect role for you after Engineering</b></p>

									<a class="main-button icon-button" href="login.php">Lets Get Started!</a>

								<?php else: ?>
									<p class="lead white-text" style="margin-left: 5px;" ><b>Hi, <?php echo htmlspecialchars($_SESSION["username"]); ?> !<br><b>Discover yourself,<br>DeepDrive Into the perfect role for you after Engineering</b></p>
			...
			<div class="container">
				...
				<div class="row">
					<div class="section-header text-center">
						...
						<h2 style="margin-top: 100px; font-size: 45px;">Welcome to APS Guidance</h2>
						...
						<p class="lead"><b style="color: rgb(56, 48, 48);">APS careers</b> is one stop destination <br>in helping you understand yourself, the best career for you <br> and providing all the resources in the process.</p>
					</div>
				</div>	
					...
					<div class="col-md-4">
						<div class="feature">
							...
							<?php endif ?>
								...
								<p>DeepDrive to find the perfect role for you after Engineering.</p>
							</div>
						</div>
					</div>
					<!-- /feature -->
		...
		<div id="cta" class="section" style="height: 400px;">
			...
			<!-- Backgound Image -->
			<div class="bg-image bg-parallax overlay" style="background-image:url(./img/test.jpg)"></div>
			<!-- /Backgound Image -->
				...
				<div class="row">
					...
					<div class="col-md-6">
							...
							<?php
								...
								<p class="lead white-text" >We Create Beautiful Experiences
									That Drive Successful Careers.</p>
									<a class="main-button icon-button" href="main.php">Lets Get Started!</a>
		...
		<div id="contact-cta" class="section" style="height: 400px;">
			...
			<!-- Backgound Image -->
			<div class="bg-image bg-parallax overlay" style="background-image:url(./img/test2.jpg)"></div>
			<!-- Backgound Image -->
