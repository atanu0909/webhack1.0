<head>
		...
		<title>APS Career guidance</title>
	...
	<body>
		...
		<!--Header-->
        <header id="header" class="transparent-nav" style="position: fixed;background-color: rgb(81, 167, 70); top: 0;">
			<div class="container">

				<div class="navbar-header">
					<!-- Logo -->
					<div class="navbar-brand">
						<a class="logo" href="main.php">APS Career Portal</a>
					</div>
					<!-- /Logo -->
