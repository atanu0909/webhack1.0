...
<head>
    ...
    <style>
        ...
        border-color: blue;
        border-radius: 30px;
        padding: 20px;  background-color:  rgb(128,128,128);}
    </style>
</head>
<body>
    <!--Header-->
    <header id="header" class="transparent-nav" style="position: fixed;background-color: rgb(186, 184, 108); top: 0;">
			<div class="container">

				<div class="navbar-header">
					<!-- Logo -->
					<div class="navbar-brand">
						<a class="logo" href="main.php" style="padding-bottom: 10px;">WELCOME TO APS CAREER</a>
					</div>
					<!-- /Logo -->
